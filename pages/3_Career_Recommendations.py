...
from utils.helper import get_session_user

st.set_page_config(page_title='Career Recommendations')
...
if submitted:
    profile = {'class':cls, 'stream':stream, 'marks':marks, 'interests':interests, 'skills':skills, 'budget':budget, 'aptitude': st.session_state.get('aptitude_result', {})}
